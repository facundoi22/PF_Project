<?php use ProximaFecha\Tools\Session; ?>

<div id='miequipo'>
<main >
		<?php
		echo "<div style='background-image: url(". $ruta ."../public/images/equipos/" . $equipo_id . "_portada.jpg)'>";
		echo "<div>";
		echo "<img src='". $ruta  ."../public/images/equipos/" . $equipo_id . "_logo_200.jpg' alt='Logo del Equipo'/>";
			...
			<div>
				...
				<div>
					...
					<div class="tresCol">
						...
						<img src="<?=$ruta?>../public/images/equipos/1_logo_100.jpg" alt="Logo del Equipo"/>
						<p>VS</p>
						<img src="<?=$ruta?>../public/images/equipos/9_logo_100.jpg" alt="Logo del Equipo"/>
						<p>PHP Futbol Club</p>
						<p>Array de 1 Indice</p>
						<p>Fecha y Hora: 12/11/2016 - 21:00hs</p>
						<p>Sede: Club Da Vinci</p>
						<img src="<?=$ruta?>../public/images/mapa.jpg" alt="Ubicación del lugar"/>
					</div>
				</div>
			</div>
		<?php } ?>
				...
				<div class="dosCol">
					...
					<div>
						<div>
							...
							<img src="<?=$ruta?>../public/images/equipos/1_logo_100.jpg" alt="Logo del Equipo"/>
							<p>4 - 2</p>
							<img src="<?=$ruta?>../public/images/equipos/6_logo_100.jpg" alt="Logo del Equipo"/>
							<p>PHP Futbol Club</p>
							<p>Puerto 7</p>
					...
					<?php } ?>
					<div id="Fravega">
						<a href="#" title="Fravega"><img style="margin: 0px" src="<?=$ruta?>../public/images/fravega.png"
														 alt="Fravega"/></a>
					</div>
				</div>
			</div>
