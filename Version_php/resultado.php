...
<html>
	...
	<body>
		<div id="resultado">
			<header>
					<div id="arriba">
						<a href="index.php" title="home"><img id="logoPrincipal" src="images/LOGOPF-Sin-Fondo.png" alt="Logo" style="margin:3px;" /></a>
						<div>
							<form method="post" id="FORMbuscador" action="#">
